                    ...
                    <div class="col-xl-6 col-lg-4">
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block">
                                <ul>
                                    <li>Support Your Dream <a href="{{ route ('shop') }}">View details</a></li>
                                    <li>Supper diskon - special for you</li>
                                    <li>Trendy Jersey , save up 50% off today <a href="{{ route ('shop') }}">Shop now</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                    <div class="logo logo-width-1 d-block d-lg-none">
                        <a href="/"><img src="assets/imgs/logo/logo (1).png" alt="logo"></a>
                    </div>
                    <div class="header-nav d-none d-lg-flex">
                        <div class="main-categori-wrap d-none d-lg-block">
                            <a class="categori-button-active" href="/">
                                <span class="fi-rs-apps"></span> PT. Kala Linea Kreasi
                            </a>
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>NO TELP</span> +62 851-7527-2830 </p>
                    </div>
        ...
        <div class="mobile-header-wrapper-inner">
            ...
            <div class="mobile-header-content-area">
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    ...
                    <nav>
                        <ul class="mobile-menu">
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a href="/">Beranda</a></li>
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a href="/">Tentang</a></li>
                ...
                <div class="mobile-header-info-wrap mobile-header-border">
                    ...
                    <div class="single-mobile-header-info">
                        <a href="http://wa.me/+6285175272830?text=Halo saya dari website Kalsport Indonesia. %0A
                        Mau buat jersey custom, Bagaimana caranya kak?" target="_blank">+62 851-7527-2830 </a>
                    </div>
                </div>
                <div class="mobile-social-icon">
                    <h5 class="mb-15 text-grey-4">Ikuti</h5>
                    <a href="https://www.instagram.com/kalsportindonesia/" target="_blank"><img src="assets/imgs/theme/icons/instagram.jpg" alt=""></a>
                    <a href="http://wa.me/+6285175272830" target="_blank"><img src="assets/imgs/theme/icons/whatsapp-logo.png" alt=""></a>
                    <a href="mailto:kalkagoods02@gmail.com" target="_blank"><img src="assets/imgs/theme/icons/email.png" alt=""></a>
                </div>
            </div>
        </div>
    </div>        
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong>Jl. Asahan Baru No.14
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>+62 851-7527-2830
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>kalkagoods@gmail.com
                            </p>
                            <h5 class="mb-10 mt-30 fw-600 text-grey-4 wow fadeIn animated">Ikuti</h5>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">Kalsport</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
