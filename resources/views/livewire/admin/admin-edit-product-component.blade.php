                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form wire:submit.prevent="updateProduct">
                                    ...
                                    <div class="mb-3 mt-3">
                                        <label for="short_description" class="form-label">Short Descrption</label>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="file" name="image" class="form_control" wire:model="newimage"/>
                                        @if($newimage)
                                            <img src="{{$newimage->temporaryUrl()}}" widht="120" />
                                            @else
                                            <img src="{{asset('assets/imgs/products')}}/{{$image}}" widht="120" />
                                        @endif    
                                        @error('newimage')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
