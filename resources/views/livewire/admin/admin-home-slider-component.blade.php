                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($slides as $slide)
                                            <tr>
                                                <td>{{ ++$i }}</td>
                                                <td><img src="{{asset('assets/imgs/slider')}}/{{ $slide->image }}" widht="80"/></td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" class="text-danger" onclick="deleteConfirmation({{ $slide->id }})" style="margin-left: 20px;">Hapus</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
